        ...
        **kwargs: Any,
        ...
        if startup_nodes:
            raise ValueError(
                ...
                "commands reliably. Point it at a single-node / cluster-mode-disabled "
                "Valkey 8.0+ endpoint instead (ElastiCache for Valkey supports vector "
                "search on a single-shard node group), or pass a single redis_url."
            )
